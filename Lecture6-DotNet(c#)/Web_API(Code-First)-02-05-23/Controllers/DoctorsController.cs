...
namespace Web_API_Code_First__02_05_23.Controllers
{
    ...
    public class DoctorsController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutDoctor(int id, DoctorPost doctor)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Doctor>> PostDoctor(DoctorPost doctor)
        {
          if (_context.Doctors == null)
          {
            ...
            return CreatedAtAction("GetDoctor", new { id = doc.Did }, doctor);
        }
