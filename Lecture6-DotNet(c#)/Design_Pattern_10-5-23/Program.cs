...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        //builder.Services.AddScoped<IRepositoryDI, RepositoryDI>();
        //builder.Services.AddTransient<IRepositoryDI, RepositoryDI>();
        //builder.Services.AddSingleton<IRepositoryDI, RepositoryDI>();
